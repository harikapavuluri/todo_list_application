...
class CustomUserCreationForm(UserCreationForm):
    ...
    def clean_confirm_password(self):
        ...
        if username and confirm_password and username.lower() in confirm_password.lower():
...
class ExportDataView(View):
    def get(self, request, *args, **kwargs):
        ...
        text_content = f"User Data:\nUsername: {user_data['username']}\n\nTask List:\n"
        for task in tasks:
            text_content += f"Title: {task.title}\n"
            text_content += f"Description: {task.description}\n"
            text_content += f"Complete: {task.complete}\n"
            text_content += f"Category: {task.category}\n"
            text_content += f"Priority: {task.priority}\n"
            text_content += f"Due Date: {task.due_date.isoformat() if task.due_date else 'N/A'}\n\n"



        # Create the HTTP response with text content
